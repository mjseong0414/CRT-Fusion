...
class NuScenesDataset(Custom3DDataset):
    ...
    def get_data_info(self, index):
        ...
        if self.point_seg:
            input_dict.update(dict(ptseg_filename=info['lidarseg_path']))
        ...
        if self.modality['use_camera']:
            if self.img_info_prototype == 'mmcv':
                ...
                if self.modality['use_radar']:
                    input_dict.update(dict(radar_sweeps=info['radar_sweeps'],
            ...
            if self.use_sequence_group_flag:
                ...
                src_lidar_to_ego[:3, :3] = Quaternion(self.data_infos[index]['lidar2ego_rotation']).rotation_matrix
                src_lidar_to_ego[:3, 3] = np.array(self.data_infos[index]['lidar2ego_translation'])
                input_dict['curr_lidar_to_ego_rt'] = src_lidar_to_ego
    ...
    def _format_bbox(self, results, jsonfile_prefix=None):
        ...
        # jsonfile_prefix = './qualitative_results/crtfusion_results/' ###############################
    ...
    def _evaluate_single(self,
        ...
        eval_set_map = {
            'v1.0-mini': 'mini_val',
            'v1.0-trainval': 'val',
            # 'v1.0-trainval': 'val_sunny',
            # 'v1.0-trainval': 'val_rain',
            # 'v1.0-trainval': 'val_day',
            # 'v1.0-trainval': 'val_night',
        }
